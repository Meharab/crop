...
var (
	...
	chaincodeName   = envOrDefault("CHAINCODE_NAME", "horticulture")
...
func createAsset(contract *client.Contract, productId string) error {
    asset := map[string]interface{}{
        ...
        "mrp": 1200.5,
        "source_of_agro_commodities_en": []string{"Filtered water", "Arsenic"},
        "source_of_agro_commodities_bn": []string{"Filtered water", "Arsenic"},
        ...
        "crop_collection_center_latitude": 23.90,
        "crop_collection_center_longitude": 90.44,
        "collector_organization_en": "Dhaka Fish Collectors",
        "collector_organization_bn": "Dhaka Fish Collectors",
        "crop_processing_unit_latitude": 23.75,
        "crop_processing_unit_longitude": 90.39,
